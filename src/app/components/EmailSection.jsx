...
const EmailSection = () => {
	...
	return (
		<section id='contact' className='grid md:grid-cols-2 my-12 md:my-12 py-24 px-24 gap-4 relative'>
			...
			<div className='z-10'>
				...
				<div className='socials flex flex-row gap-2'>
					<Link href='https://github.com/AlinDedu' target='_blank' rel='noopener noreferrer'>
						<Image src={GithubIcon} alt='Github Icon' />
					</Link>
					<Link href='https://www.linkedin.com/in/alin-dedu/' target='_blank' rel='noopener noreferrer'>
